                ...
                <div class="col s10 offset-s1">
                    <div class="card white center-align" id="home-profile-card"><img id="home-profile-img" src="images/profile.jpg">
                        ...
                        <div class="row align-center cta-buttons">
                            <div class="col s12 m6 l3 offset-l3"><a class="btn waves-effect" href="/blog">Blog</a></div>
                            <div class="col s12 m6 l3"><a class="btn waves-effect" href="/projects">Projects</a></div>
                        </div>
                    </div>
                </div>
            </div>
